...
$Arr = getuserpage("select * from ".tname('special')." where in_uid=".$missra_in_userid." and in_passed=0 and in_classid=".$cid." order by in_addtime desc", 10, 4);
}else{
$get = true;
$Arr = getuserpage("select * from ".tname('special')." where in_uid=".$missra_in_userid." and in_passed=0 order by in_addtime desc", 10, 3);
}
?>
<!DOCTYPE html>
<html>
