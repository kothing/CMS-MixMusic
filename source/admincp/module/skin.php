...
<div class="container">
	<script type="text/javascript">
		...
		if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;设置模板';
	</script>
	<div class="floattop">
...
?>
<div class="container">
	<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 编辑模板';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;编辑模板';</script>
	<div class="floattop">
...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 浏览模板';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;浏览模板';</script>
<div class="floattop">
	<div class="itemtitle">
		<h3>浏览模板</h3>
	</div>
...
<div class="container">
	<script type="text/javascript">
		parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 模板方案';
		if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;模板方案';
	</script>
	<div class="floattop">
		<div class="itemtitle">
			<h3>模板方案</h3>
		...
		<tr>
			...
			<td colspan="2" width="30%">
				<div class="template-thumb">
					<p><img width="100%" height="160" style="cursor:pointer" onclick="location.href='?iframe=skin&action=templist&tempname=<?php echo $row['in_name']; ?>&path=<?php echo $row['in_path']; ?>';" title="<?php echo $row['in_name']; ?>" onerror="this.src='static/admincp/images/preview.gif'" src="<?php echo $temp; ?>preview.jpg" /></p>
				</div>
