...
function clean_cache(){
	...
	if(!document.getElementById("data").checked){
		...
		document.getElementById("loader").innerHTML="<h4 class=\"infotitle1\">正在更新缓存，请稍候......</h4><img src=\"static/admincp/images/loader.gif\" class=\"marginbot\" />";
...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 工具 - 更新缓存';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='工具&nbsp;&raquo;&nbsp;更新缓存';</script>
