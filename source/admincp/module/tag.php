...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 音乐标签';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;音乐标签';</script>
<div class="floattop">
	<div class="itemtitle">
		<!-- <h3>
		<?php 
