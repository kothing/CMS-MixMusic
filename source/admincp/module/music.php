...
<div class="container">
	<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 内容 - <?php echo $arrname; ?>音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>音乐';</script>
	<div class="floattop">
		<div class="itemtitle">
			<!-- <h3><?php //echo $arrname; ?>音乐</h3> -->
			<ul class="tab1">
...
<tr>
	<td class="lightnum">
		音乐名称：<input type="text" class="txt" value="<?php echo $in_name; ?>" name="in_name" id="in_name">
	...
	<td class="lightnum">
		所属栏目：<select name="in_classid" id="in_classid">
...
<tr>
	<td>
		所属歌手：<select name="in_singerid" id="in_singerid">
		<option value="0">不选择</option>
		<?php
...
<tr>
	<td>
		下载权限：<select name="in_grade" id="in_grade">
...
<tr>
	<td class="longtxt lightnum">音频地址：<input type="text" class="txt" value="<?php echo $in_audio; ?>" name="in_audio" id="in_audio"></td><td>
		<input class="btn" type="button" value="上传音频" onclick="pop.up('no', '上传音频', 'source/pack/upload/open.php?type=music_audio&form=form2.in_audio', '406px', '180px', '175px');" />&nbsp;&nbsp;<a href="javascript:void(0)" onclick="pop.record();" class="addtr">录制音频</a>
	</td>
</tr>

<tr>
	<td class="longtxt">封面地址：<input type="text" class="txt" value="<?php echo $in_cover; ?>" name="in_cover" id="in_cover"></td><td>
		<input class="btn" type="button" value="上传封面" onclick="pop.up('no', '上传封面', 'source/pack/upload/open.php?type=music_cover&form=form2.in_cover', '406px', '180px', '175px');" />
	</td>
</tr>

<tr>
	<td class="longtxt">歌词地址：<input type="text" class="txt" value="<?php echo $in_lyric; ?>" name="in_lyric" id="in_lyric"></td><td>
		<input class="btn" type="button" value="上传歌词" onclick="pop.up('no', '上传歌词', 'source/pack/upload/open.php?type=music_lyric&form=form2.in_lyric', '406px', '180px', '175px');" />
	</td>
</tr>
</table>
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 所有音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;所有音乐';</script>";} ?>
<?php if($action=="pass"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 待审音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;待审音乐';</script>";} ?>
<?php if($action=="wrong"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 报错音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;报错音乐';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 搜索音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;搜索音乐';</script>";} ?>
<?php if($action=="list"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 栏目音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;栏目音乐';</script>";} ?>
<?php if($action=="special"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 专辑音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;专辑音乐';</script>";} ?>
<?php if($action=="singer"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 歌手音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;歌手音乐';</script>";} ?>
<div class="floattop">
<div class="itemtitle">
	<ul class="tab1">
...
<td><?php if($row['in_passed']==1){ ?><a href="?iframe=music&action=editpassed&in_id=<?php echo $row['in_id']; ?>"><img src="static/admincp/images/pass_no.gif" /></a><?php }else{ ?><img src="static/admincp/images/pass_yes.gif" /><?php } ?></td>
