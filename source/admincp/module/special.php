...
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - <?php echo $arrname; ?>专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>专辑';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<td><input class="btn" type="button" value="上传封面" onclick="pop.up('no', '上传封面', 'source/pack/upload/open.php?type=special_cover&form=form2.in_cover', '406px', '180px', '175px');" /></td>
</tr>
</table>
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 所有专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;所有专辑';</script>";} ?>
<?php if($action=="pass"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 待审专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;待审专辑';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 搜索专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;搜索专辑';</script>";} ?>
<?php if($action=="list"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 栏目专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;栏目专辑';</script>";} ?>
<?php if($action=="singer"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 歌手专辑';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;歌手专辑';</script>";} ?>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<td><?php if($row['in_passed']==1){ ?><a href="?iframe=special&action=editpassed&in_id=<?php echo $row['in_id']; ?>"><img src="static/admincp/images/pass_no.gif" /></a><?php }else{ ?><img src="static/admincp/images/pass_yes.gif" /><?php } ?></td>
...
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 专辑栏目';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;专辑栏目';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
			<li><a href="?iframe=special"><span>所有专辑</span></a></li>
...
<a href="?iframe=special&action=edithideclass&in_id=<?php echo $row['in_id']; ?>&in_hide=0"><img src="static/admincp/images/show_no.gif" /></a>
<?php }else{ ?>
<a href="?iframe=special&action=edithideclass&in_id=<?php echo $row['in_id']; ?>&in_hide=1"><img src="static/admincp/images/show_yes.gif" /></a>
<?php } ?>
</td>
