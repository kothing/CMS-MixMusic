...
<?php } ?>
	...
	<table class="tb tb2 fixpadding">
		...
		<tr><td class="vtop td24 lineheight">程序版本</td><td class="lineheight smallfont">MixMusic <?php echo IN_VERSION; ?> 简体中文<?php echo strtoupper(IN_CHARSET); ?> <?php echo IN_BUILD; ?></td></tr>
