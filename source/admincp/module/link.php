...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 系统 - <?php echo $arrname; ?>链接';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>链接';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 系统 - 友情链接';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;友情链接';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<td><?php if($row['in_hide']==1){ ?><a href="?iframe=link&action=editisindex&in_hide=0&in_id=<?php echo $row['in_id']; ?>"><img src="static/admincp/images/show_no.gif" /></a><?php }else{ ?><a href="?iframe=link&action=editisindex&in_hide=1&in_id=<?php echo $row['in_id']; ?>"><img src="static/admincp/images/show_yes.gif" /></a><?php } ?></td>
