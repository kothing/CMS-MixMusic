...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 系统 - 系统用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;系统用户';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<table class="tb tb2">
	...
	<tr class="hover">
		...
		<td><?php if($row['in_islock']==1){ ?><a href="?iframe=admin&action=islock&in_adminid=<?php echo $row['in_adminid']; ?>&in_islock=0&hash=<?php echo $_COOKIE['in_adminpassword']; ?>"><img src="static/admincp/images/show_no.gif" /></a><?php }else{ ?><a href="?iframe=admin&action=islock&in_adminid=<?php echo $row['in_adminid']; ?>&in_islock=1&hash=<?php echo $_COOKIE['in_adminpassword']; ?>"><img src="static/admincp/images/show_yes.gif" /></a><?php } ?></td>
...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 系统 - <?php echo $arrname; ?>用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='系统&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>用户';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
