...
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - <?php echo $arrname; ?>视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>视频';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<tr>
<td class="longtxt">视频地址：<input type="text" class="txt" value="<?php echo $in_play; ?>" name="in_play" id="in_play"></td><td><input class="btn" type="button" value="上传视频" onclick="pop.up('no', '上传视频', 'source/pack/upload/open.php?type=video_play&form=form2.in_play', '406px', '180px', '175px');" /></td>
</tr>
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 所有视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;所有视频';</script>";} ?>
<?php if($action=="pass"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 待审视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;待审视频';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 搜索视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;搜索视频';</script>";} ?>
<?php if($action=="list"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 栏目视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;栏目视频';</script>";} ?>
<?php if($action=="singer"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 歌手视频';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;歌手视频';</script>";} ?>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<td><?php if($row['in_passed']==1){ ?><a href="?iframe=video&action=editpassed&in_id=<?php echo $row['in_id']; ?>"><img src="static/admincp/images/pass_no.gif" /></a><?php }else{ ?><img src="static/admincp/images/pass_yes.gif" /><?php } ?></td>
...
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 视频栏目';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;视频栏目';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
			<li><a href="?iframe=video"><span>所有视频</span></a></li>
...
<a href="?iframe=video&action=edithideclass&in_id=<?php echo $row['in_id']; ?>&in_hide=0"><img src="static/admincp/images/show_no.gif" /></a>
<?php }else{ ?>
<a href="?iframe=video&action=edithideclass&in_id=<?php echo $row['in_id']; ?>&in_hide=1"><img src="static/admincp/images/show_yes.gif" /></a>
<?php } ?>
</td>
