...
?>
<div class="container">
<?php if($_GET['action']=="add"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 新增标签';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;新增标签';</script>";} ?>
<?php if($_GET['action']=="edit"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 编辑标签';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;编辑标签';</script>";} ?>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 模板标签';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;模板标签';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 界面风格 - 标签分类';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='界面风格&nbsp;&raquo;&nbsp;标签分类';</script>";} ?>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
