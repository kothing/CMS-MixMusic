...
?>
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 内容审核 - 音乐栏目';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;音乐栏目';</script>
...
<a href="?iframe=class&action=edithide&in_id=<?php echo $row['in_id']; ?>&in_hide=0"><img src="static/admincp/images/show_no.gif" /></a>
<?php }else{ ?>
<a href="?iframe=class&action=edithide&in_id=<?php echo $row['in_id']; ?>&in_hide=1"><img src="static/admincp/images/show_yes.gif" /></a>
<?php } ?>
</td>
...
<?php
	...
	function Unite(){
		...
		$db->query("update ".tname('music')." set in_classid=".$Class_2." where in_classid=".$Class_1);
