...
<?php function main(){ ?>
<script type="text/javascript">parent.document.title = 'MixMusic 管理中心 - 全局 - 站点信息';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='全局&nbsp;&raquo;&nbsp;站点信息';</script>
    ...
    <div class="container">
        ...
        <table class="tb tb2">
            ...
            <tbody class="sub" id="mailopen" <?php if(IN_MAILOPEN<>1){echo 'style=\"display:none;\"';} ?>>
                ...
                <tr><td class="vtop"><input type="text" class="txt" value="<?php echo IN_MAILSMTP; ?>" name="IN_MAILSMTP"></td><td class="vtop tips2">发邮件时所指定的服务器</td></tr>
                <tr><td colspan="2" class="td27">E-mail 密码:</td></tr>
                <tr><td class="vtop"><input type="text" class="txt" value="<?php echo IN_MAILPW; ?>" name="IN_MAILPW"></td><td class="vtop tips2">发邮件时需要验证的密码</td></tr>
            </tbody>
            <tr>
                <td colspan="2" class="td27">后台提问开关:</td></tr>
            <tr>
            <td class="vtop">
                <ul>
            ...
            <td class="vtop tips2">为了站点安全起见，建议开启</td></tr>
            <tbody class="sub" id="codeopen" <?php if(IN_CODEOPEN<>1){echo 'style=\"display:none;\"';} ?>>
                <tr><td colspan="2" class="td27">认证码:</td></tr>
                <tr><td class="vtop"><input type="text" class="txt" value="<?php echo IN_CODE; ?>" name="IN_CODE"></td><td class="vtop tips2">管理员登录后台时的安全提问答案</td></tr>
            </tbody>
        ...
        <table class="tb tb2">
            ...
            <tr>
                ...
                <td class="vtop tips2">暂时将站点关闭，前台无法访问，但不影响后台访问</td>
            </tr>
            <tbody class="sub" id="in_open" <?php if(IN_OPEN<>0){echo 'style=\"display:none;\"';} ?>>
            <tr><td colspan="2" class="td27">维护说明:</td></tr>
            <tr><td class="vtop"><textarea rows="6" name="IN_OPENS" cols="50" class="tarea"><?php echo IN_OPENS; ?></textarea></td><td class="vtop tips2">前台显示的维护信息</td></tr>
            </tbody>
