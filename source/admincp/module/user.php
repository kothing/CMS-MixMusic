...
<div class="container">
<script type="text/javascript">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 编辑用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;编辑用户';</script>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 所有用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;所有用户';</script>";} ?>
<?php if($action=="vip"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 绿钻会员';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;绿钻会员';</script>";} ?>
<?php if($action=="lock"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 锁定状态';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;锁定状态';</script>";} ?>
<?php if($action=="star"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 明星认证';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;明星认证';</script>";} ?>
<?php if($action=="staring"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 待审明星';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;待审明星';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'MixMusic Board 管理中心 - 用户管理 - 搜索用户';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='用户管理&nbsp;&raquo;&nbsp;搜索用户';</script>";} ?>
<div class="floattop">
	<div class="itemtitle">
		<ul class="tab1">
